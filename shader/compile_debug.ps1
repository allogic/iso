...
glslangValidator -I"." -V -g -Od --target-env vulkan1.3 -o vdb/iso_renderer.task.spv vdb/iso_renderer.task
...
glslangValidator -I"." -V -g -Od --target-env vulkan1.3 -o vdb/tile_placer.comp.spv vdb/tile_placer.comp
