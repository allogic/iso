...
glslangValidator -I"." -V --target-env vulkan1.3 -o nox/default.vert.spv nox/default.vert
glslangValidator -I"." -V --target-env vulkan1.3 -o nox/default.frag.spv nox/default.frag

glslangValidator -I"." -V --target-env vulkan1.3 -o vdb/pre_depth.vert.spv vdb/pre_depth.vert
glslangValidator -I"." -V --target-env vulkan1.3 -o vdb/pre_depth.frag.spv vdb/pre_depth.frag
...
glslangValidator -I"." -V --target-env vulkan1.3 -o vdb/frustum_culling.comp.spv vdb/frustum_culling.comp
