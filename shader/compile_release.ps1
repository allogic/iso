...
glslangValidator -I"." -V --target-env vulkan1.3 -o vdb/chunk_renderer.vert.spv vdb/chunk_renderer.vert
glslangValidator -I"." -V --target-env vulkan1.3 -o vdb/chunk_renderer.frag.spv vdb/chunk_renderer.frag
...
glslangValidator -I"." -V --target-env vulkan1.3 -o vdb/greedy_mesher.comp.spv vdb/greedy_mesher.comp