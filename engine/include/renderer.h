...
typedef struct chunk_mask_t {
  ...
  uint32_t opaque_px_mask[CHUNK_SIZE * CHUNK_SIZE];
  uint32_t opaque_py_mask[CHUNK_SIZE * CHUNK_SIZE];
  uint32_t opaque_pz_mask[CHUNK_SIZE * CHUNK_SIZE];
  uint32_t opaque_nx_mask[CHUNK_SIZE * CHUNK_SIZE];
  uint32_t opaque_ny_mask[CHUNK_SIZE * CHUNK_SIZE];
  uint32_t opaque_nz_mask[CHUNK_SIZE * CHUNK_SIZE];
} chunk_mask_t;
